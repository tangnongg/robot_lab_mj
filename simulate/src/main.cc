...
void *UnitreeSdk2BridgeThread(void *arg)
{
  ...
  const bool use_hg_bridge =
      param::config.robot.find("g1") != std::string::npos ||
      param::config.robot.find("b2") != std::string::npos ||
      param::config.robot.find("a2") != std::string::npos;
